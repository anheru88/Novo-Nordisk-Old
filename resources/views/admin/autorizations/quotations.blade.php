        ...
        <section class="content">
            <div class="box box-info quot">
                ...
                <div class="box-body">
                    ...
                    'false', 'v-on:submit' => 'authQuota', 'ref'=>'authQuota']) !!}
                    {{ csrf_field() }}
                    <div class="quot-number">
                        ...
                        <div class="col-xs-2">
                            ...
                            <div class="quot-data-box-content"><i class="fa fa-calendar"></i>
                                {{ date('Y-m-d', strtotime($quotation->created_at )) }}</div>
                        </div>
                        <div class="col-xs-2">
                            <div class="quot-data-box-title">Vigente desde</div>
                            <div class="quot-data-box-content"><i class="fa fa-calendar"></i>
                                {{ date('Y-m-d', strtotime($quotation->quota_date_ini))}}</div>
                        </div>
                        <div class="col-xs-2">
                            <div class="quot-data-box-title">Vigente hasta</div>
                            <div class="quot-data-box-content"><i class="fa fa-calendar"></i>
                                {{ date('Y-m-d', strtotime($quotation->quota_date_end))}}</div>
                        </div>
                    </div>
                    ...
                    <div class="container-fixed">
                        <div class="row quot-add-product">
                            ...
                            <div class="col-xs-12">
                                <table id="quotations" data-toggle="table" data-pagination="true" data-search="true" class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                    ...
                    <div class="quot-send-btn-accept">
                        <div class="tools-btns-gen">
                            ...
                            'btn btn-basic tools-menu-btn buttons-accept pull-right white-text btn-approved', 'v-on:click' => 'approved ='.$answer]) }}
                        </div>
                    </div>
...
<script>
    $("#file-1").fileinput({
        allowedFileExtensions: ['jpg', 'png', 'gif','doc','pdf','xls','docx','xls','xlsx'],
