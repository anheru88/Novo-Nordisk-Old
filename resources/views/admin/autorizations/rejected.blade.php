            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="datatable_full" data-pagination="true" data-search="true" class="table table-striped table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{ route('autorizaciones.cotizacion',['id' => $quotation->id_quotation ]) }}">{{ $quotation->id_quotation }}</a>
                                    </td>
                                    <td><a href="{{ route('autorizaciones.cotizacion',['id' => $quotation->id_quotation ]) }}">{{ $quotation->cliente->client_name }}</a>
                                    </td>
                                    ...
                                    <td>
                                        {!! statusCot($quotation->is_authorized) !!}
                                    </td>
                                    <td>
                                        @can('autorizaciones.show')
                                        <button class="btn btn-xs btn-info"><a
                                                href="{{ route('autorizaciones.show', ['id' => $quotation->id_quotation]) }}"><i class="fas fa-search"></i></a></button>
                                        @endcan
                                    </td>
                                </tr>
                                @endforeach
