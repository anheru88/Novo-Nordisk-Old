...
<body>
    <div class="border-pattern">
        <div class="content">
            ...
            <br>
            <p class="inter_text">
                Adicionalmente, me permito confirmar el cupo de crédito es de COP
                @if ($cliente->client_credit)
                <strong>${{ $cliente->client_credit }}</strong>
                @else
                <strong>$0</strong>
                @endif
                y el plazo de pago es <strong>{{ $cliente->payterm->payterm_name }}</strong>.
            </p>
            ...
            <div class="firm">
                <div class="headerLeft" align="left">
                    <p><img src="{{ asset('uploads/firms/firma.png') }}" width="300px" alt="not.found"></p>
                </div>
		<p></p>
