...
<div class="content-wrapper">
    ...
    <div class="quotation" id="app">
        <section class="content-header">
            ...
            <h1>
                {{ strtoupper($pricelist->list_name) }} </h1> | Creada el {{ date('d/m/Y',strtotime($pricelist->created_at)) }}
                        ...
                        <table id="informe" data-toggle="table" data-pagination="true" data-search="true" class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true" class="text-center">Precio Institucional</th>
                                    <th data-sortable="true" class="text-center">Precio Máximo</th>
                                    @if(sizeof($pricelistinstitucional) > 0)
                                    @for($i = 1; $i < sizeof($pricelistinstitucional[0]); $i++) <th data-sortable="true" width="12%"
                                        class="text-center">Descuento Nivel {{ $i + 1 }}</th>
                                        @endfor
                                        @endif
                                        <th data-sortable="true" width="10%" class="text-center">Vigencia desde</th>
                                        <th data-sortable="true" width="10%" class="text-center">Vigencia hasta</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if($productos->count())
                    ...
                    <div class="container-fixed table-responsive">
                        <table id="informe2" data-toggle="table" data-pagination="true" data-search="true" class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th data-sortable="true">Producto</th>
                                    <th data-sortable="true" class="text-center">Precio Comercial</th>
                                    <th data-sortable="true" class="text-center">Precio Máximo</th>
                                    @if(sizeof($pricelistcomercial) > 0)
                                    @for($i = 1; $i < sizeof($pricelistcomercial[0]); $i++) <th data-sortable="true" width="12%"
                                        class="text-center">Descuento Nivel {{ $i + 1 }}</th>
                                        @endfor
                                        @endif
                                        <th data-sortable="true" width="10%" class="text-center">Vigencia desde</th>
