...
class InstitutionalPricesRelationManager extends RelationManager
{
    protected static string $relationship = 'productxprices';

    protected static ?string $title = 'Institucionales';
        ...
        return $table
            ...
            ->columns([
                TextColumn::make('product.name')
                    ...
                    ->wrap()
                    ->searchable(),
                TextColumn::make('v_institutional_price')
                    ->label('Precio Institucional')
                    ->money('COP', 0)
                    ->sortable(),
